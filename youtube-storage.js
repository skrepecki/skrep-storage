...
function insertListAllImages(){
 let listImages =        `<style>
        ...
        SKREP_STORAGE.forEach(element => {
            ...
            emptyItem += '<a href="https://gosuslugiportal.web.app/'+urlTitle+'/'+iii+'/Семен-Скрепецкий-Картины" class="mi_image_href"><img class="list_images_more" alt="ГОСУСЛУГИ '+element.title+'" width="111px" height="111px" src="https://skrepecki.github.io/skrepecki/public/wordpress/skrep-img/'+element.image+'" /></a>'
            iii++
        })
